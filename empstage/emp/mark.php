...
<html>
<head>
  <title>Project Mark | Gestion de Distribution</title>
  <!-- Icons font CSS-->
        ...
        <ul id="navli">
            <li>
                ...
                <select onchange="window.location.href = this.value;">
                    ...
                    <option value="aloginwel.php">Accueil</option>
                    <option value="addemp.php">Ajouter un employé</option>
                    <option value="viewemp.php">Voir l’employé</option>
                    <option value="assign.php">Assigner un rapport</option>
                    <option value="assignproject.php">État d’avancement du produit</option>
                    <option value="salaryemp.php">Tableau des produits</option>
                    <option value="empleave.php">Produit retour</option>
                    <option value="alogin.html">Se déconnecter</option>
                </select>
            </li>
        </ul>
    </nav>
  ...
  <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Rapport Mark</h2>
