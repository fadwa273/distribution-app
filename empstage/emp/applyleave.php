...
<head><meta charset="UTF-8">
	<title>Apply Leave | Employee Panel | System Gestion de Distribution</title>
...
<header>
		<nav>
			...
			<ul id="navli">
				...
				<li><a class="homeblack" href="empproject.php?id=<?php echo $id?>"">Proudit</a></li>
				<li><a class="homered" href="applyleave.php?id=<?php echo $id?>"">Demander un rapport</a></li>
	...
	<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Formulaire de demande de rapport</h2>
                    <form action="process/applyleaveprocess.php?id=<?php echo $id?>" method="POST">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                            	<p>Start Date</p>
                                <div class="input-group">
                                    <input class="input--style-1" type="date" placeholder="commencer" name="start">
                            ...
                            <div class="col-2">
                                ...
                                <div class="input-group">
                                    <input class="input--style-1" type="text"  name="nombre">
