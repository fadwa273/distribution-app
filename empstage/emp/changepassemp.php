...
<html>
<head>
  <title>Change Password | system de gestion d'Employee </title>
  <!-- Icons font CSS-->
...
<body>
  <header>
    <nav>
      <h1>system de gestion d'Employee </h1>
      <ul id="navli">
        <li><a class="homeblack" href="eloginwel.php?id=<?php echo $id?>">Home</a></li>
        <li><a class="homered" href="myprofile.php?id=<?php echo $id?>">Me Profile</a></li>
        <li><a class="homeblack" href="applyleave.php?id=<?php echo $id?>">Demander un congé</a></li>
